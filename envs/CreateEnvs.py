...
def createOfflineEnv(shape, folder_name, reward, max_steps=500, render=False, id=0):
    # Register the environment
    ...
    print(shape)
    # Create the environment
    env = gym.make(id, maze=maze, folder_name=folder_name, reward=reward, render=render, max_steps_per_episode=max_steps)
